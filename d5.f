...
c       
       ...
       L=17.8921d0 ! system size, change when changing packing fraction
       ii=17.8921d0
       jj=17.8921d0
       ax=0.0
       ay=0.0
       ...
       open(unit=38,file="msd_0.4_v1.dat")   ! change packing fraction here
       open(unit=11,file="dacf_0.4_v1.dat")
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      do iens=1,nens
        ...
        iseed = iseed + 2*iens
        ndim=0
        write(filename_1, '(A,I0,A)') 'msd_0.4_v1_ens', iens, '.dat' ! change packing fraction here
        open(unit=50+iens, file=trim(filename_1))
        
        write(filename_2, '(A,I0,A)') 'd_0.4_v1_ens', iens, '.dat'
